...
function mypassion_contact_info( $atts, $content = null ){
	...
	return '<h5 class="line"><span>'.$title.'</span></h5><span class="liner"></span>
                            ...
                            <div class="contact-info">
                            	<p class="man"><i class="icon-location"></i>'.$address.'</p>
                                <p class="phone"><i class="icon-phone"></i> Phone: '.$phone.'. <br />Fax:  '.$fax.'.</p>
                                <p class="envelop"><i class="icon-mail"></i>Email: <span>'.$email.'</span> <br /> Web: <a href="'.$website.'">'.$website.'</a></p> 
                            </div>';
}
...
function register_buttons($buttons) {  
   ...
   array_push($buttons, /*"testimonial",*/ "alert", "quote", "dropcap", "tooltip", "highlight", "list", "headlines", "clear", /*"skill", "separator", "member", "pricing_table", "projectdetails", */"icon");  
   return $buttons;
}  
