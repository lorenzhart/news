    ...
    tinymce.create('tinymce.plugins.contact_info', {  
        init : function(ed, url) {  
            ed.addButton('contact_info', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[contact_info title="Location" address="Creative Laboratory <br />77 New York Avenue, New York city, <br />USA 10000." phone="73 443 11 23" fax="73 443 11 23" email="email@mail.com" website="http://www.weblink.com"] Your content goes here[/contact_info]');  
