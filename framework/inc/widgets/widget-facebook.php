...
class widget_facebook extends WP_Widget { 
	...
	function widget_facebook() {
		$widget_ops = array('description' => __('Display Facebook Like Box', 'framework') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'facebook' );
		$this->WP_Widget( 'facebook', __('MyPassion - Facebook', 'framework'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		if($page_url): ?>
		<iframe src="http://www.facebook.com/plugins/likebox.php?href=<?php echo urlencode($page_url); ?>&amp;width=<?php echo esc_html($width); ?>&amp;colorscheme=<?php echo esc_html($color_scheme); ?>&amp;show_faces=<?php echo esc_html($show_faces); ?>&amp;stream=<?php echo esc_html($show_stream); ?>&amp;header=<?php echo esc_html($show_header); ?>&amp;height=<?php echo esc_html($height); ?>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:<?php echo esc_html($width); ?>px; height: <?php echo esc_html($height); ?>px;" allowTransparency="true"></iframe>
		<?php endif;
		echo $after_widget;
		// ------
	}
	...
	function form($instance) {
		...
		$defaults = array('title' => 'Find us on Facebook', 'page_url' => 'https://www.facebook.com/envato', 'width' => '298', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
		...
		<p>
            ...
            <small>For example: https://www.facebook.com/envato</small>
		</p>
