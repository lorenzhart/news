...
class counter_widget extends WP_Widget {
      	...
      	<div class="sidebar">
			...
			<ul class="social">
				...
				<li>
                    ...
                    <span><?php echo @number_format($fans); ?> <br/> <i><?php _e('Fans' , 'framework' ) ?></i></span>
                </li>
				<?php endif; ?>
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['fans'] =  strip_tags($new_instance['fans']) ;
	...
	function form( $instance ) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'fans' ); ?>" name="<?php echo $this->get_field_name( 'fans' ); ?>"  value="<?php echo $instance['fans']; ?>" class="widefat" type="text" />
			<small>Facebook fans number here</small>
		</p>
		<p>
