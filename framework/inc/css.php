...
<?php if(0){ ?>
body, input, textarea{ text-align:right;direction: rtl;}
.logo{ float:right; }
div.search { float:left; }
.sf-menu{ float:right; }
.sf-menu>li{ float:right; margin-right:0; margin-left:30px; }
.sf-menu li ul{ padding-right:20px; }
.badg{ float:right; right:0; }
span.liner{ float:right; position:relative; right:0; }
.caption, .flex-caption{ text-align:right; }
.block span.mypassion-rating{float:right;}
.block li{float:right;}
.block > li > a > img, .wnews > li > img{float:right; margin:0 0 10px 20px;}
.block span.mypassion-rating span{float:left;}
ul#carousel{text-align:right;}
.next{float:left;}
.prev{float:left; margin:0 0 0 2px}
.prev span{background-position: -14px 4px}
.next span {background-position:5px 4px;}
.bestreview > li > a > img, .block2 li img{float:right; margin:0 0 10px 20px;}
.bestreview span.mypassion-rating, span.mypassion-rating {float:right;}
.bestreview span.mypassion-rating span, span.mypassion-rating span{float:left;}
.ui-tabs .ui-tabs-nav li{float:right;}
.ui-tabs .ui-tabs-nav li{margin-right:0; margin-left:1.2em;}
