...
if (!class_exists('mypassion_user_rating')) {
    class mypassion_user_rating
    {
        ...
        function __construct()
        {
            ...
            add_action('wp_ajax_mypassion_rating', array(&$this, 'sync_rating'));
            add_action('wp_ajax_nopriv_mypassion_rating', array(&$this, 'sync_rating'));
        ...
        public function load_scripts()
        {
          global $post;
          if ($post) {
                wp_localize_script('jquery', 'mypassion_script', array(
                                    'post_id' => $post->ID,
